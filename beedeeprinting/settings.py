"""
Django settings for beedeeprinting project.
...
SECRET_KEY = 'i5r&1uzex59xash772d$imx%q_e5p%o3y68*0mx5+nqt$sg3tw'
...
EMAIL_USE_TLS = True
EMAIL_PORT = 587
EMAIL_HOST_USER = "beedee.printing@gmail.com"
EMAIL_HOST_PASSWORD = "mlrliyridouecwze"
# Static files (CSS, JavaScript, Images)
# https://docs.djangoproject.com/en/3.1/howto/static-files/

STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, "static")]
STATIC_ROOT = 'home2/ihostingtest55/repositories/beedeeprintingv2/'
